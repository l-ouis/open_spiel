...
`[num_distinct_actions()]`, representing a flat probability distribution over
all actions. Games may override this to provide a structured shape (e.g. a 2D
grid for board games).
